...
export const CardsDataEn = [
	...
	{
		title: 'Reaql-backend',
		description: `Reaql-backend - this is a back-end application written on the following technology stack: Typescript, Nestjs, Typeorm, PostgreSQL, Redis. <br>
	...
	{
		title: 'Vudo-frontend',
		description: `Vudo-frontend - this is a front-end application written on the following technology stack: Vuejs, Vuex, Scss.<br> 
		The app has a repository on github. When you push changes to the main branch of the repository, the build is automatically started and the application is submitted to the heroku hosting.<br>
		`,
		repoLink: 'https://github.com/dan-exxx1st/vudo-frontend',
		appLink: 'https://vudo-frontend.herokuapp.com/',
	...
	{
		title: 'Vudo-backend',
		description: `Vudo-backend - this is a back-end application written on the following technology stack: TypeScript, Fastify.js, Objection.js. <br>
		Оно тестируется e2e-тестами с применением следующих технологий и библиотек: Jest, Supertest.<br>
        The app has a repository on github. When you push changes to the main branch of the repository, the build is automatically started and the application is submitted to the heroku hosting.<br>
		`,
		repoLink: 'https://github.com/dan-exxx1st/vudo-backend',
	...
	{
		title: 'React-pizza',
		description: `React-pizza - this is a front-end application written on the following technology stack: TypeScript, React, Mobx. <br>
        The app has a repository on github. When you push changes to the main branch of the repository, the build is automatically started and the application is submitted to the heroku hosting.<br>
		`,
		repoLink: 'https://github.com/dan-exxx1st/react-pizza',
		appLink: 'https://exxx1st-react-pizza.herokuapp.com/',
